...
Grab the BRSWallet zip from [GitHub](https://github.com/burst-apps-team/burstcoin/releases) (always be sure to check link to the latest version. (2.4.0 was latest at time of writing)

`wget https://github.com/burst-apps-team/burstcoin/releases/download/v2.4.0/burstcoin-2.4.0.zip`
...
**`unzip burstcoin-2.4.0.zip -d BRSWallet/`**
...
**`nano brs-default.properties`**

Configure line 196-198 and replace the following lines:
